...
class DrawerRoot(DrawerBaseComponent):
    ...
    def create(
        ...
        *children,
        ...
        reposition_inputs: Var[bool] | bool | None = None,
        snap_points: Sequence[float | str] | None = None,
        active_snap_point: Var[bool] | bool | None = None,
        fade_from_index: Var[int] | int | None = None,
        snap_to_sequential_point: Var[bool] | bool | None = None,
        unstyled: Var[bool] | bool | None = None,
        style: Sequence[Mapping[str, Any]]
        | Mapping[str, Any]
        | Var[Mapping[str, Any]]
        ...
        on_scroll_end: EventType[()] | None = None,
        on_unmount: EventType[()] | None = None,
        set_active_snap_point: EventType[()] | EventType[int] | None = None,
        **props,
    ) -> DrawerRoot:
