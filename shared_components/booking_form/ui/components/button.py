...
def button(
    *children: rx.Component | str | rx.Var | None,
    ...
    **props,
    ...
    Args:
        *children: The children components or text to display inside the button.
        variant: The button variant. Defaults to "primary".
        size: The button size. Defaults to "sm".
        class_name: Additional CSS classes to apply to the button. Defaults to "".
    ...
    if variant not in BUTTON_STYLES["variant"]:
        msg = f"Invalid variant: {variant}. Must be one of {list(BUTTON_STYLES['variant'].keys())}"
