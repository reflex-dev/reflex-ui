...
from shared.views.sidebar import navbar_sidebar_button
...
def marketing_navbar() -> rx.Component:
    from shared.views.hosting_banner import hosting_banner
